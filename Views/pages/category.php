                ...
                <div class="product-view row quickview-w">
                    <div class="left-content-product">
                        ...
                        <div class="content-product-left class-honizol col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div id="thumb-slider" class="yt-content-slider full_slider owl-drag owl2-carousel owl2-theme owl2-responsive-768 owl2-loaded" data-rtl="yes" data-autoplay="no" data-autoheight="no" data-delay="4" data-speed="0.6" data-margin="10" data-items_column0="4" data-items_column1="3" data-items_column2="4" data-items_column3="1" data-items_column4="1" data-arrows="yes" data-pagination="no" data-lazyload="yes" data-loop="no" data-hoverpause="yes">
        ...
        <?php foreach ($data['products'] as $product):?>
            ...
            <div class="product-layout col-lg-3 col-md-4 col-sm-4 col-xxs-6 col-xs-12">
                ...
                <form action="?route=index/cartadd" method="POST">
                    ...
                    <button class="" type="submit"><i class="fa fa-shopping-basket"></i></button>
                 </form> 
                 
                <div class="product-item-container">
                    <div class="left-block left-b">
                        <div class="product-card__gallery product-card__left">
                            <div class="item-img thumb-active" data-src="<?php echo $product['img'];?>"><img src="<?php echo $product['img'];?>" alt="image"></div>
                            <div class="item-img" data-src="<?php echo $product['img'];?>"><img src="<?php echo $product['img'];?>" alt="image"></div>
                            
                        </div>
                        <div class="product-image-container">
                            <a href="product.html" target="_self" title="Pariatur porking">
                                <img src="<?php echo $product['img'];?>" class="img-1 img-responsive" alt="image">
                            </a>
                        </div>
                    ...
                    <div class="right-block right-b">
                        ...
                        <div class="caption">
                            <h4><a href="product.html" title="Pariatur porking" target="_self"><?php echo $product['name'];?></a></h4>
                            ...
                            <div class="price"> 
                                <span class="price-new"><?php echo $product['price'];?> руб</span>
                                <?php if($product['old_price'] != null):?>
                                    <span class="price-old"><?php echo $product['old_price'];?> руб</span>
                                <?php endif;?>
                            </div>
                            ...
                            <div class="list-block hidden">
                                    ...
                                    <button class=" btn-button" type="submit" title="Add to Cart"><i class="fa fa-shopping-basket"></i>
                                    </button>
                                ...
                                <span class="iframe-link btn-button quickview quickview_handler visible-lg" title="Quick view" data-fancybox-type="iframe" data-toggle="modal" data-target="#myModal">
                                    <i class="fa fa-eye"></i>
                                </span>                                                        
