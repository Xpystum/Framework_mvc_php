            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center">
                                <a href="product.html"><img  width="85" class="img-thumbnail" title="Xitefun Causal Wear Fancy Shoes" alt="Xitefun Causal Wear Fancy Shoes" src="image/catalog/demo/product/funiture/7.jpg">
                                </a>
                            </td>
                            <td class="text-left"><a href="product.html">Fancy Xitefun Causal Wear  Shoes</a>
                            </td>
                            <td class="text-center">#1565255</td>
                            <td class="text-center">2</td>
                            <td class="text-center">Shipped</td>
                            <td class="text-center">02/01/2018</td>
                            <td class="text-right">$133.20</td>
                            <td class="text-center"><a class="btn btn-info" title="" data-toggle="tooltip" href="order-information.html" data-original-title="View"><i class="fa fa-eye"></i></a>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-center">
                                <a href="product.html"><img  width="85" class="img-thumbnail" title="Xitefun Causal Wear Fancy Shoes" alt="Xitefun Causal Wear Fancy Shoes" src="image/catalog/demo/product/funiture/5.jpg">
                                </a>
                            </td>
                            <td class="text-left"><a href="product.html">Causal Xitefun Wear Fancy Shoes</a>
                            </td>
                            <td class="text-center">#1565246</td>
                            <td class="text-center">1</td>
                            <td class="text-center">Shipped</td>
                            <td class="text-center">20/01/2018</td>
                            <td class="text-right">$233.20</td>
                            <td class="text-center"><a class="btn btn-info" title="" data-toggle="tooltip" href="order-information.html" data-original-title="View"><i class="fa fa-eye"></i></a>
                            </td>
                        </tr>
