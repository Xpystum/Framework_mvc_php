    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="mySmallModalLabel" style="font-weight: bold;">Ошибка</h4>
            </div>
            <div class="modal-body">
                <div class="alert alert-warning" role="alert" style="font-size:2rem;"><?php echo $data ?></div>
            </div>
        </div>
    </div>
</div>
